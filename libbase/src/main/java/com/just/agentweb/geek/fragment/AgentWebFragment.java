...
import com.just.agentweb.geek.client.MiddlewareChromeClient;
import com.just.agentweb.geek.client.MiddlewareWebViewClient;
import com.just.agentweb.geek.common.CommonWebChromeClient;
import com.just.agentweb.geek.common.FragmentKeyDown;
import com.just.agentweb.geek.common.UIController;
    ...
    private PopupMenu.OnMenuItemClickListener mOnMenuItemClickListener = new PopupMenu.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            if (itemId == R.id.refresh) {
                ...
                if (mAgentWeb != null) {
                    AgentUtils.toCopy(AgentWebFragment.this.getContext(), mAgentWeb.getWebCreator().getWebView().getUrl());
                }
                return true;
            } else if (itemId == R.id.default_browser) {
                if (mAgentWeb != null) {
                    AgentUtils.openBrowser(AgentWebFragment.this.getContext(), mAgentWeb.getWebCreator().getWebView().getUrl());
                }
                return true;
