...
public class PileLayout extends ViewGroup {
    ...
    public PileLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.pileHorizontalTransitionLayout);
        interval = (int) a.getDimension(R.styleable.pileHorizontalTransitionLayout_interval, interval);
        sizeRatio = a.getFloat(R.styleable.pileHorizontalTransitionLayout_sizeRatio, sizeRatio);
        scaleStep = a.getFloat(R.styleable.pileHorizontalTransitionLayout_scaleStep, scaleStep);
        displayCount = a.getFloat(R.styleable.pileHorizontalTransitionLayout_displayCount, displayCount);
        a.recycle();
