...
public class CityPickerAct extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        } else if (theme == R.style.CityPickerStyleCustomTheme) {
        ...
        themeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (themeBtn.getText().toString().startsWith("自定义")) {
                    ...
                    themeBtn.setText("自定义主题");
                    theme = R.style.CityPickerStyleCustomTheme;
                }
                recreate();
            }
        });
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (id == R.id.cb_hot) {
            ...
            anim = isChecked ? R.style.CityPickerStyleCustomAnim : R.style.DefaultCityPickerAnimation;
