...
public class CardSwipeStack extends ViewGroup {
    ...
    private CardSwipeHelper mSwipeHelper;
    private DataSetObserver mDataObserver;
    private SwipeStackListener mListener;
    private SwipeProgressListener mProgressListener;
    private boolean enrandom;

    public boolean isEnrandom() {
        return enrandom;
    }

    public void setEnrandom(boolean enrandom) {
        this.enrandom = enrandom;
    }

    public CardSwipeStack(Context context) {
        this(context, null);
    }

    public CardSwipeStack(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CardSwipeStack(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize() {
        ...
        mSwipeHelper = new CardSwipeHelper(this);
...
//                bottomView.setRotation(mViewRotation - (mViewRotation / 2));
            }
    ...
    public void onSwipeEnd() {
        if (mProgressListener != null) {
            mProgressListener.onSwipeEnd(getCurrentPosition());
        }
    }
