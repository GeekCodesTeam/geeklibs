...
public class ImagePickerActivitylibxuanzeqi extends FragmentActivity implements OnSelectListener {
    private final PickCallback pickCallback = new PickCallback() {
        ...
        public void onPermissionDenied(String[] permissions, String message) {
            Toast.makeText(ImagePickerActivitylibxuanzeqi.this, message, Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onPickImage(@Nullable Uri imageUri) {
            Toast.makeText(ImagePickerActivitylibxuanzeqi.this, String.valueOf(imageUri), Toast.LENGTH_SHORT).show();
        }
    };
