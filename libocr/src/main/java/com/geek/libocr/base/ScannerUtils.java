...
public class ScannerUtils {
     ...
     * @return
     */
    public static com.geek.libocr.base.Result decodeIdCard(Context context, Bitmap bmp) throws Exception {
        if (bmp == null) {
            return null;
        }
...
//     * @return
//     */
//    public static com.geek.libocr.base.Result decodeIdCard2(Bitmap bmp) throws Exception {
//        if (bmp == null) {
//            return null;
//        }
//        if (bmp.getWidth() % 2 == 1 || bmp.getHeight() % 2 == 1) {
...
//            IdCard2Utils.close();
//            com.geek.libocr.base.Result result = new com.geek.libocr.base.Result();
//            result.type = s.contains("cardNumber") ? com.geek.libocr.base.Result.TYPE_ID_CARD_FRONT : com.geek.libocr.base.Result.TYPE_ID_CARD_BACK;
//            result.data = s;
//            return result;
//        } catch (Exception e) {
//        }
